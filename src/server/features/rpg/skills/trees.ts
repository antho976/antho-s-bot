...
const WARRIOR_TREE: SkillTree = {
  ...
  nodes: [
    ...
    { id: "o4", type: "active", name: "Berserk", desc: "Active", x: 750, y: 100, ability: "berserk", detail: "+50% damage and +25% damage taken for 3 turns." },
    ...
    { id: "d3", type: "active", name: "Shield Wall", desc: "Active", x: 90, y: 120, ability: "shield_wall", detail: "40% less damage taken for 3 turns." },
    ...
    { id: "s3", type: "active", name: "Rampage", desc: "Active", x: 485, y: 505, ability: "rampage", detail: "+10% damage per hit landed, up to +50%." },
  ],
  edges: [
